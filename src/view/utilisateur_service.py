...
class UtilisateurService:
    ...
    @log
    def modifier(self, u: Utilisateur, *, rehash_password: bool = False):
        """
        Mettre à jour un utilisateur complet.
        Si rehash_password=True, on considère que u.mdp_hash contient le mot de passe en clair.
        """
        if rehash_password and u.mdp_hash:
